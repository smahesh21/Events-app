...
class Events extends Component {
  ...
  getEventRegistrationStatus = () => {
    ...
    const isActiveEvent = eventsList.find(
      eachEvent => eachEvent.id === isActiveId,
    )

    if (isActiveEvent) {
      console.log(isActiveEvent.registrationStatus)
      return isActiveEvent.registrationStatus
    }
    return ''
  }
      ...
      <div className="event-container">
        ...
        <div className="registration-container">
          <ActiveEventRegistrationDetails
            getEventRegistrationStatus={this.getEventRegistrationStatus()}
          />
        </div>
      </div>
    )
